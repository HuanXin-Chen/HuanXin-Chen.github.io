...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691831838996-0eef112b-6465-4ae4-bae9-debe368f15b5.png#averageHue=%23272d26&clientId=ub4ab8205-0ddc-4&from=paste&height=450&id=u7887f3d9&originHeight=450&originWidth=1010&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=783013&status=done&style=none&taskId=u8a377121-bcfd-4fa2-8b1b-acce5e73a66&title=&width=1010)
## 走进SpringBoot一站式开发
> 本文基于最新的SpringBoot3进行分享。

### 什么是SpringBoot？
Spring Boot让您可以轻松地创建独立的、生产级别的Spring应用程序，并“直接运行”这些应用程序。SpringBoot为大量的第三方库添加了支持，能够做到开箱即用，简化大量繁琐配置，用最少的配置快速构建你想要的项目。在2023年，SpringBoot迎来了它的第三个大版本，随着SpringBoot 3的正式发布，整个生态也迎来了一次重大革新。<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691832439206-4c769d8e-8dfa-43a8-8f98-acaa069b8440.png#averageHue=%23232a2e&clientId=ub4ab8205-0ddc-4&from=paste&height=308&id=u743ad04b&originHeight=308&originWidth=1208&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=30448&status=done&style=none&taskId=u3775e42d-a345-48ac-a6ba-1f2477dde8a&title=&width=1208)<br />在3.X之后的变化相比2.X可以说是相当大，尤其是其生态下的SpringSecurity框架，旧版本项目在升级之后API已经完全发生改变；以及内置Tomcat服务器的升级，Servlet也升级到5以上，从`javax`全新升级到`jakarta`新包名；包括在3.X得到的大量新特性，如支持GraalVM打包本地镜像运行等；并且Java版本也强制要求为17版本。迁移到新版本不仅可以享受到免费维护支持，也可以感受Java17带来的全新体验。
### SpringBoot的功能
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691829055968-2dedab3d-4aa1-4bda-a234-bba64f46bf1c.png#averageHue=%231b1f24&clientId=ub4ab8205-0ddc-4&from=paste&height=1108&id=u135e3773&originHeight=1108&originWidth=2271&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=113162&status=done&style=none&taskId=u972ded04-267c-46f9-9106-f7f103c2865&title=&width=2271)<br />当然，IDEA神奇已经内置集成了，我们也通过直接在IDEA上创建<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691829109159-25c2f53e-b9dd-451f-a7cc-d137631abfa8.png#averageHue=%2303182a&clientId=ub4ab8205-0ddc-4&from=paste&height=651&id=ub2fe05bf&originHeight=651&originWidth=772&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=56510&status=done&style=none&taskId=ueefb8c50-821e-4f51-9f42-47e8d6d4aeb&title=&width=772)<br />实现@SpringBootApplication。
```java
...
```
测试启动项目，顺利成功！<br />![](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691555545535-fd1dc9a1-7538-4991-9f7a-0e70fe42bd38.png#averageHue=%23021829&from=url&id=NKdz1&originHeight=332&originWidth=1687&originalType=binary&ratio=1.5&rotation=0&showTitle=false&status=done&style=none&title=)
### 常用模块整合
首先是最基本的starter模块
```java
<dependency>
...
### 轻松打包发布
#### 一键命令jar包形式
直接点击Maven中的package<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691829864469-e94d6090-064d-4d60-ac94-b4fe3384df73.png#averageHue=%2302101d&clientId=ub4ab8205-0ddc-4&from=paste&height=599&id=u1d471aff&originHeight=599&originWidth=991&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=40224&status=done&style=none&taskId=u6e5b852e-168e-4b2f-8d54-0758d805185&title=&width=991)<br />只要能够安装JRE环境，都可以通过命令一键运行。
```
java -jar jar包
```
#### 传统tomcat手动war包
...
```
最后，我们再次运行Maven 的package指令就可以打包为war包了<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691589211791-db20ad97-b666-4dc6-bbe0-8149e511ba96.png#averageHue=%23041727&clientId=u092292e2-f0fb-4&from=paste&height=135&id=u03ea719e&originHeight=151&originWidth=600&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=13536&status=done&style=none&taskId=u1ba9fa73-05b0-4057-aca1-65b8b4cc5fc&title=&width=535)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691589520396-0548887d-77e3-4ffd-9bfa-d57e113113d7.png#averageHue=%23f0e8e7&clientId=u092292e2-f0fb-4&id=jIqNb&originHeight=92&originWidth=1572&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u2687bef4-3bf5-4656-96aa-1592a7b2634&title=)
...
Slf4j本身只是一个接口规范，它定义了一组日志输出的方法，如info()、debug()、error()等。这些方法可以在应用程序中使用，而具体的日志实现则由各个框架自行选择和配置。<br />实际上，Slf4j提供了适配器（Adapter）的机制，可以将不同的日志框架与Slf4j进行集成。这样，应用程序中的Slf4j日志调用会被适配到具体的日志实现上，实现了对不同日志框架的统一调用。<br />通过这种偷梁换柱的方式，我们可以在应用程序中使用统一的Slf4j接口进行日志输出，而不需要关心具体的日志实现细节。在Spring Boot中，通常会将Slf4j与Logback作为默认的日志实现，但你也可以根据自己的需求进行配置，使用其他日志框架，如Log4j、Log4j2等。<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691832490869-3bb55571-eae0-4cfd-a246-287bdb1509f7.png#averageHue=%23f8f1f0&clientId=ub4ab8205-0ddc-4&from=paste&height=593&id=u86fc41f1&originHeight=593&originWidth=881&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=161223&status=done&style=none&taskId=u21e032fe-77b2-4b11-ae26-6f2a9ba45d3&title=&width=881)<br />所以，SpringBoot为了统一日志框架的使用，做了这些事情：

- 直接将其他依赖以前的日志框架剔除
- 导入对应日志框架的Slf4j中间包
- 导入自己官方指定的日志实现，并作为Slf4j的日志实现层

![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691590158961-589ef912-debc-453a-9f70-c6c432ea39aa.png#averageHue=%2303192b&clientId=u092292e2-f0fb-4&from=paste&height=502&id=u5d1f83cb&originHeight=483&originWidth=585&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=45502&status=done&style=none&taskId=u73508d2d-5f32-46dd-9e8c-f8c9f3955fc&title=&width=608)
### 打印日志信息
...
```
### Maven打包控制
我们如果希望生产环境中不要打包开发环境下的配置文件呢，我们目前虽然可以切换开发环境，但是打包的时候依然是所有配置文件全部打包，这样总感觉还欠缺一点完美，因此，打包的问题就只能找Maven解决了。<br />通过配置maven，此时在构建选项会多出一些配置选择按钮<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691596697436-3662f2a8-bae8-4833-abcc-083861e99146.png#averageHue=%23051625&clientId=u092292e2-f0fb-4&from=paste&height=131&id=ue6b9fdb1&originHeight=106&originWidth=523&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=4368&status=done&style=none&taskId=u79cddc3b-0cdc-4330-9f33-5c0ded114f4&title=&width=648.6666870117188)<br />配置方法如下：
```java
<!--分别设置开发，生产环境-->
<profiles>
    <!-- 开发环境 -->
...
他们的工作流程如下：<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691832510872-239fd9be-11de-48c3-a2c7-c0a34d8d97a9.png#averageHue=%23f2f2f2&clientId=ub4ab8205-0ddc-4&from=paste&height=274&id=ubc479175&originHeight=274&originWidth=759&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=87947&status=done&style=none&taskId=u9c1ed9a6-c9fe-4f6f-b6b2-a978a7dedfd&title=&width=759)<br />下面是一个简单使用例子：<br />我们需要先进行邮箱配置（在你的邮箱信息中去查找）
```java
spring:
  mail:
...
```
直接访问：http://localhost:8080/swagger-ui/index.html<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/29466846/1691832558335-b943799b-8dee-44bf-85c0-f3e224677d80.png#averageHue=%23f2f2f2&clientId=ub4ab8205-0ddc-4&from=paste&height=699&id=ua2d2a332&originHeight=699&originWidth=1215&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=60682&status=done&style=none&taskId=u02652e71-0e57-426e-b607-a0dc2bf277a&title=&width=1215)<br />可以看到这个开发文档中自动包含了我们定义的接口，并且还有对应的实体类也放在了下面。这个页面不仅仅是展示接口，也可以直接在上面进行调试，堪比Postman，是不是很棒！
## 结束语
